...
Prose contributions and comments must be your own writing. Do not prompt an LLM to expand on or explain your idea and then post the output; just provide the idea itself.
...
Nothing in this policy is intended to prohibit reasonable use of assistive technology, so long as the contributor remains responsible for the resulting prose and it represents their own work.

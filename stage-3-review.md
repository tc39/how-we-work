...
- Is the specification text logical and consistent, matching the rest of the JavaScript specification? (For this kind of review, it can be useful to refresh yourself on the [editorial](./editorial-conventions.md) and [normative](./normative-conventions.md) conventions.)
